...
export function activate(context: vscode.ExtensionContext) {
    ...
    if (serverPath === 'hxo-lsp' && vscode.workspace.workspaceFolders) {
        ...
        const possiblePaths = [
            ...
            path.join(workspaceRoot, 'compilers', 'hxo-lsp', 'target', 'debug', 'hxo-lsp'),
            path.join(workspaceRoot, 'compilers', 'hxo-lsp', 'target', 'release', 'hxo-lsp'),
        ];
    ...
    const clientOptions: LanguageClientOptions = {
        ...
        synchronize: {
            fileEvents: vscode.workspace.createFileSystemWatcher('**/hxo.config.toml'),
        },
    };
